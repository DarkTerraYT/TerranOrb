...
{
    internal class OsmiumGenPass : GenPass
    {
        public OsmiumGenPass(string name, double loadWeight) : base(name, loadWeight)
        {
        }
        ...
        protected override void ApplyPass(GenerationProgress progress, GameConfiguration configuration)
        {
            ...
            for (int i = 0; i < maxToSpawn; i++)
            {
                ...
                WorldGen.TileRunner(x, y, WorldGen.genRand.Next(3, 6), WorldGen.genRand.Next(2, 5), ModContent.TileType<OsmiumOre>());
            }
        }
    }
}